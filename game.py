...
def mousePosition():
    ...
    if choice==0:
        if (duckCoor[0][0]<=mousex<=(duckCoor[0][0]+90)) and ((duckCoor[0][1]-130)<=mousey<=(duckCoor[0][1]-5)):
            return True
    elif choice==1:
        if (duckCoor[1][0]<=mousex<=(duckCoor[1][0]+90)) and ((duckCoor[0][1]-130)<=mousey<=(duckCoor[0][1]-5)):
            return True
    elif choice==2:
        if (duckCoor[2][0]<=mousex<=(duckCoor[2][0]+90)) and ((duckCoor[0][1]-130)<=mousey<=(duckCoor[0][1]-5)):
            return True
    elif choice==3:
        if (duckCoor[3][0]<=mousex<=(duckCoor[3][0]+90)) and ((duckCoor[0][1]-130)<=mousey<=(duckCoor[0][1]-5)):
            return True
    return False
